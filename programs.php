...
// Check if this is accessed via "লক্ষ্য GPA 5" link
$is_gpa_5 = isset($_GET['filter']) && $_GET['filter'] === 'gpa5';

// Fetch categories from the categories table
if ($is_gpa_5) {
    // Filter to show only school/SSC programs for GPA 5
    $categories_sql = "SELECT * FROM categories WHERE category LIKE 'School Program%' ORDER BY category ASC";
} else {
    // Show all categories
